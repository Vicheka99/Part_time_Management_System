@php
    $menus = [
        ...
        ['label' => 'Courses', 'icon' => 'mdi-book-open-variant', 'url' => route('index.course'), 'paths' => ['course/index', 'course/create', 'course/update/*', 'admin/class-schedule', 'admin/class-students']],
